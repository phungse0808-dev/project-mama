...
/* ค่าชุดนี้ต้องตรงกับตาราง INK ใน levelInk.ts
   เป็นสีเดียวกันคนละที่ เพราะที่นี่คีย์เป็นระดับของการแจ้งเตือน
   ส่วนที่โน่นคีย์เป็นสีพื้นของระดับคุณภาพอากาศ แก้ที่ใดที่หนึ่งต้องตามไปแก้อีกที่
