...
/** ขอบบนของระดับเริ่มมีผลกระทบต่อสุขภาพ ตามเกณฑ์ของกรมควบคุมมลพิษ
 *
 * ใช้เป็นคอลัมน์สุดท้ายของตารางเทียบ แทนการตั้งค่าฝุ่นหนักขึ้นมาเอง
 * ทุกคอลัมน์ในตารางนั้นจึงเป็นเส้นที่มีที่มา อธิบายได้ว่าเอาตัวเลขมาจากไหน
 */
const HEALTH_EFFECT_LEVEL = 75;
        ...
        <div className="chart">
          <ResponsiveContainer width="100%" height={280}>
            <AreaChart data={series} margin={{ top: 8, right: 16, bottom: 8, left: -8 }}>
              ...
              <YAxis tick={{ fontSize: 13 }} unit="%" width={68} />
              <Tooltip
                contentStyle={{
                  borderRadius: 8,
                  borderColor: "#ccd6e0",
