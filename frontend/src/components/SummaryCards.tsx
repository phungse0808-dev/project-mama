 ...
 *
 * ตัวเลขใช้ฟอนต์ความกว้างคงที่ขนาด 17.5 พิกเซล บีบระยะห่างอีก 0.5
 * วัดของจริงบนหน้าเว็บได้ตัวละ 10 พิกเซล เลขสองหลักจึงกว้าง 20
 * เผื่อช่องไฟรวมอีก 3.5 พิกเซล กันไม่ให้ตัวเลขชิดขอบช่วงพอดีจนดูอึดอัด
 *
...
function labelWidth(count: number): number {
  return String(count).length * 10 + 3.5;
}
