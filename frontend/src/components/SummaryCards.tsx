 ...
 *
 * ตัวเลขใช้ฟอนต์ความกว้างคงที่ขนาด 26 พิกเซล บีบระยะห่างอีก 0.5
 * วัดของจริงบนหน้าเว็บได้ตัวละ 15.1 พิกเซล เลขสองหลักจึงกว้าง 30.2
 * เผื่อช่องไฟรวมอีก 5 พิกเซล กันไม่ให้ตัวเลขชิดขอบช่วงพอดีจนดูอึดอัด
 *
...
function labelWidth(count: number): number {
  return String(count).length * 15.1 + 5;
}
