 ...
 *
 * ตัวเลขใช้ฟอนต์ความกว้างคงที่ขนาด 14.5 พิกเซล บีบระยะห่างอีก 0.5
 * วัดของจริงบนหน้าเว็บได้ตัวละ 8.2 พิกเซล เลขสองหลักจึงกว้าง 16.4
...
function labelWidth(count: number): number {
  return String(count).length * 8.2 + 3;
}
